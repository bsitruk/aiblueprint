...
<DocCardGrid>
  ...
  <DocCard href="/concepts/skills" icon="Sparkles" title="Skills" description="Reusable workflows for implementation, prompting, and more." />
  ...
  <DocCard href="/concepts/use-artifacts" icon="FileText" title="use-artifacts" description="Polished local HTML for plans, options, and prototypes." />
